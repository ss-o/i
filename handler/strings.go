...
var (
	archRe    = regexp.MustCompile(`(aarch64|armv6|armv7|armv8|arm64|arm|x32|amd32|x86(-|_)?32|386|x64|amd64|x86(-|_)?64|mips)`)
...
func getArch(s string) string {
	...
	if a == "x64" || a == "x86_64" || a == "x86-64" {
		a = "amd64"
	} else if a == "x32" || a == "amd32" || a == "x86_32" || a == "x86-32" {
		a = "386"
	}
	return a
}
